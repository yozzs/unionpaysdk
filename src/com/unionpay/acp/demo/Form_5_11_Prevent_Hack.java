 ...
 */
public class Form_5_11_Prevent_Hack extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		data.put("txnSubType", "02");                          //交易子类型  默认00
		data.put("bizType", "000803");                         //业务类型 代收

		data.put("productId", "S002");                         //产品编码
		...
		resp.getWriter().write("防HACK</br>请求报文:<br/>"+reqMessage+"<br/>" + "应答报文:</br>"+rspMessage+"");
