...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_Identification/form_5_18_SMS_Code_Verfication" target="_blank">
<p>
<label>商户号：</label>
