...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_Identification/form_5_14_ID_Info_Check_Return_Photo" target="_blank">
<p>
<label>商户号：</label>
