...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_Identification/form_5_22_Enterprise_Info_Query_Front" target="_blank">
<p>
<label>商户号：</label>
