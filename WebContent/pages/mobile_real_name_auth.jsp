...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_Identification/form_5_15_Mobile_Real_Name_Auth" target="_blank">
<p>
<label>商户号：</label>
