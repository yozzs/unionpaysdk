...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_Identification/form_5_21_Enterprise_Info_Identification_Front" target="_blank">
<p>
<label>商户号：</label>
