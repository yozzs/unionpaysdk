...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_Identification/form_5_8_Enterprise_Info_Batch_Identification" target="_blank">
<p>
<label>商户号：</label>
...
<p>
<label>总笔数：</label>
<input id="totalQty" type="text" name="totalQty" placeholder="填写总笔数" value="" title="大于0整数" required="required"/>
</p>
<p>
<label>&nbsp;</label>
